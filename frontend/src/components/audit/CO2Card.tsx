    ...
    <Card variant="default" className="p-5 space-y-4 bg-emerald-50/40 border-emerald-200">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="font-bold text-slate-900 text-sm">Environmental CO₂ Footprint</h3>
            <p className="text-[11px] text-slate-500">Annual household emissions impact</p>
          </div>
        </div>

        {annualReduction > 0 && (
          <span className="px-2.5 py-1 rounded-full text-[11px] font-bold bg-emerald-100 text-emerald-900 border border-emerald-300">
            -{annualReduction} kg CO₂ / yr
          </span>
        )}
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 text-xs">
        <div className="p-3 bg-white rounded-xl border border-emerald-200/80 space-y-0.5">
          <span className="text-[10px] text-slate-400 font-semibold uppercase">Current Footprint</span>
          <p className="text-base font-bold text-slate-900 font-mono">
            {currentCO2} <span className="text-xs font-normal text-slate-500">kg/yr</span>
          </p>
        </div>

        <div className="p-3 bg-white rounded-xl border border-emerald-200/80 space-y-0.5">
          <span className="text-[10px] text-slate-400 font-semibold uppercase">Post-Optimization</span>
          <p className="text-base font-bold text-emerald-600 font-mono">
            {afterCO2 !== undefined && afterCO2 !== null ? afterCO2 : currentCO2} <span className="text-xs font-normal text-slate-500">kg/yr</span>
          </p>
        </div>
      </div>
    </Card>
